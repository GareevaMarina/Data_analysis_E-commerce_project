...
# Доставленные заказы имеют статусы 'доставлен' и 'отменен'. Статус canceled: судя по данным заказ доставлен
# и сразу отменен
...
# 5.Провести когортный анализ пользователей. В период с января по декабрь выявить когорту с самым высоким
